package com.example.rifqi.portal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.navigation_1:
                Toast.makeText(getApplicationContext(), "nav 1 Telah Dipilih", Toast.LENGTH_SHORT).show();

                return true;
            case R.id.navigation_2:
                Toast.makeText(getApplicationContext(),"nav2 Telah Dipilih",Toast.LENGTH_SHORT).show();
                return true;
